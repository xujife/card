...
<script type="text/javascript">
    ...
    $(function () {
        ...
        to_page(1, sno);//默认显示第一页数据
    });

    function to_page(pn, sno) {
        $.ajax({
            url: "${App_Path}/student_information",
            data: {pn: pn, sno: sno},
            type: "GET",
    ...
    function show_pageBag(result) {
        ...
        if (result.extend.informations.hasPreviousPage == false) {
            ...
            pre.click(function () {
                to_page(result.extend.informations.pageNum - 1, sno);
            })
        }
        ...
        if (result.extend.informations.hasNextPage == false) {
            ...
            last.click(function () {
                to_page(result.extend.informations.pages, sno);
            })
        }
